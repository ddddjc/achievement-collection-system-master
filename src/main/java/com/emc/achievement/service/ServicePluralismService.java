...
public interface ServicePluralismService {

    ResponseResult insertSelective(ServicePluralism record);

    ResponseResult updateByPrimaryKeySelective(ServicePluralism record);
